;Act as $0130.
;This is the bottom-right of the 32x32 pixel block gate.
...
print "A solid 32x32 bottom-right block locked gate that opens when the player have a matching key."