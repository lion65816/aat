;Act as $0130.
;This is the right of the 32x16 pixel block gate.
...
print "A solid 16x32 right block locked gate that opens when the player have a matching key."