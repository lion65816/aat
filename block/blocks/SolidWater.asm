...
!FireballRules	= 1	;Should Mario's fireballs follow the same rules as Mario?    (0=No)
!YoshiRules	= 1	;Should Yoshi and Baby Yoshi follow the same rules as Mario? (0=No)
!ActsLike	= $0002	;Acts Like number which should be used for non-Mario block interactions
