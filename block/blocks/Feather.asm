...
; JMP WallFeet : JMP WallBody ; when using db $37
	...
	if !NSMB_NoOldPowerupExtract == 0
		...
		LDA #$04				;>The feather cape mario is currently picking up gets stored.
		STA $0DC2|!addr
		RTL
	endif
	...
	if !NSMB_NoOldPowerupExtract == 0
		...
		db $01 ;>When super mario grabs flower/feather (in smw, would extract mario's previous powerup and places into item box)
		db $04 ;>When cape mario grabs flower/feather
		db $02 ;>When fire mario grabs flower/feather
	endif
print "Same as the feather sprite."