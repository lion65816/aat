...
+   REP #$20
    ...
    CMP $00             ; if sprite or mario xpos > sprite, return
    BCS .continue8
...
print "Activates the nearest laser shooter to the right of the block when touched by the player or a sprite."
