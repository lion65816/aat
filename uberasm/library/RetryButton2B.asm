...
!level = $002B			; Change this if needed.
...
!ReachedTop     = $1929|!addr	;> PSI Ninja edit: 1 byte of freeram to keep track of whether or not the autoscroll has stopped (from ConstantAutoscroll2B.asm).
...
main:
	...
	PLY
	PLX
	STZ !ReachedTop			;> PSI Ninja edit: Reset flag used by ConstantAutoscroll2B.asm. Reset in case the top of the screen is reached, so that autoscroll is unlocked upon retry.
	RTL
