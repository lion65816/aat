...
GENERATE_SPRITE:     LDA #$09                ; \ play sound effect
					...
					LDA $178B|!Base2,x             ; check y position and shoot up or down accordingly
...
LEFT:				LDA $178B|!Base2,x             ; check y position and shoot up or down accordingly
                    AND #$10                ; todo: change this check
                    BNE SHOOT_UP
					LDA #$07
					BRA FIRE
