;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Shower Venus, by imamelia (optimized by Blind Devil)
;;
;; This Venus Fire Trap spits fireballs in an arc at the player.  The size of the arc
;; depends on where the player is standing at the time of firing.
;;
...
SetFireFlag:		;
LDA #$01		;
STA !1534,x		; set the "firing" flag
LDA !160E,x		;
STA !187B,x		; set the fireball counter
ASL #4			;
CLC			;
ADC #$08		;
STA !1558,x		; set the fire timer
DEC !1540,x		; decrement the sprite state timer one extra time
NoFire1:		;
RTS			;
...
LDA !1558,x		;
AND #$0F		; if the fireball timer isn't at a number divisible by 10...
BNE NoFire1		;
JMP SpitFireballs		;
