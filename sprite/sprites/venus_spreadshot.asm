;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Spreadshot Venus, by imamelia (optimized by Blind Devil)
;;
;; This Venus Fire Trap spits multiple fireballs at once that spread out.
;; The original idea came from Koyuki (he made the original Spreadshot Venus),
;; so credit to him, even though this is based off my own Venus Fire Trap, not his.
;;
;; Uses first extra bit: YES
;; Uses first extra property bytes: YES
;;
;; If the first extra bit is clear, the sprite will spit 3 fireballs.  If the first extra bit
;; is set, the sprite will spit 5 fireballs.
;;
...
LDY #$02		; if the extra bit is clear, the sprite will spit 3 fireballs
LDA !7FAB10,x	; check the extra bit
AND #$04	; if the extra bit is set...
BEQ Init3Fireballs	;
INY #2		; the sprite will spit 5 fireballs
Init3Fireballs:	;
TYA		;
STA !160E,x	;
...
db $0C,$F4,$0C,$F4
FireYSpeeds1:
db $06,$06,$FA,$FA,$09,$09,$F7,$F7,$03,$03,$FD,$FD
FireYSpeeds2:
db $06,$06,$FA,$FA,$08,$08,$F8,$F8,$04,$04,$FC,$FC,$0A,$0A,$F6,$F6,$02,$02,$FE,$FE

SpitFireballs:
LDA !160E,x
STA $05		; set the fireball counter
...
LDY $04
LDA FireXOffsetsLo,y
STA $00
LDA FireYOffsetsLo,y
STA $01
