...
!SpawnIsCustom = 0	;carried sprite is custom or normal? - 0 = normal. 1 = custom.

!SpawnNum =	$0F	;carried sprite number.
!SpawnTile =	$AA	;16x16 tile to use for the carried sprite.
!SpawnProp =	$14	;tile properties for carried sprite, YXPPCCCT format.
