...
MOTION2_GFX:		JMP SUB_GFX5	;���[�V����2�̂Ƃ��̕`��
...
TILEMAP1:            db $C7,$C8,$E7,$E8      ;�g��4�̃^�C��
TILEMAP3:            db $C4,$C5,$E4,$E5      ;�g��4�̃^�C��
...
LOOP_START1:         PHX
		...
		;LDA $05	;���[�V�����ԍ��`�F�b�N
		;CMP #$03
		;BEQ MOTION3_GFX_DRAW

	LDA TILEMAP3,x
	;BRA END_DRAW

;MOTION3_GFX_DRAW	LDA TILEMAP3,x
;			BRA END_DRAW
...
M3X_SPEED:             db $E0,$20 ;�ːi���x�@�E�A��

SUB_MOTION_03:	;�t�@�C�A��΂����[�V����
...
GEN_NOKOERI:         JSL $02A9DE|!bank             ; \ get an index to an unused sprite slot, RETURN if all slots full
                    ...
                    LDA #$3D             ;�����ɐ����������J�X�^���X�v���C�g�X�v���C�g�ԍ�������
                    PHX
                    TYX
                    STA !7FAB9E,x
                    PLX
