...
!FireSFX = $08
!FirePort = $1DFC
!SpawnedSprite = $91	;sprite to spawn. default is bob-omb.
!IsCustom = 0		;if 1, the spawned sprite will be custom. else it'll be normal.

!SpawnYSpeed = $D0	;vertical speed of spawned sprite.

!BobOmbIsStunned = 1	;if 1, and a bob-omb is spawned, then it'll be stunned with some frames about to explode.
