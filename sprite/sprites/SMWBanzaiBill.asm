...
!BanzaiGFX7	=	$C4	;tile of one of the connector parts of the sprite. It's also used below.
!BanzaiGFX8	=	$CA	;tile of the other connector part of the sprite. It's also used below.
