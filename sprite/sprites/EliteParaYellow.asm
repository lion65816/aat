;�G���[�g�̒��̒��̍ŏ㋉�I�I�p�^�p�^�G���[�g�C�G���[�l���@�I�I�@
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; nokonoko init JSL
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;C2,x=���[�V�����ԍ�
;	0=�a���̂悤�ɓo��@1=���܂ꂽ���@2=�㏸�@3=�t�@�C�A�I 4=�ď㏸ 5=�|�[�W���O����
;	6=�������邮��b��
...
MOTION0_GFX:		JMP SUB_GFX4	;���[�V����0�̂Ƃ��̕`��
MOTION1_GFX:		JMP SUB_GFX2	;���[�V����1�̂Ƃ��̕`��
MOTION3_GFX:		JMP SUB_GFX1	;���[�V����3�̂Ƃ��̕`��
MOTION5_GFX:		JMP SUB_GFX5	;���[�V����5�̂Ƃ��̕`��
MOTION6_GFX:		JMP SUB_GFX6	;���[�V����6�̂Ƃ��̕`��
			GFX_ENDEND:	;�`�您���
...
TILEMAP1:            db $C4,$C5,$E4,$E5     ;1�Ԗڂ̃A�j���[�V�����Ɏg��4�̃^�C��
...
TILEMAP5:             db $C0,$C2,$E0,$E2     ;1�Ԗڂ̃A�j���[�V�����Ɏg��4�̃^�C��
                    db $C0,$C2,$85,$E2     ;2�Ԗڂ̃A�j���[�V�����Ɏg��4�̃^�C��
X_OFFSET5:            db $08,$F8,$08,$F8,$F8,$08,$F8,$08     ;�E�������^�C����x���W/���������^�C����x���W
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; graphics routine �P�^�C���@�A�j������@�������邮��R�E��
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
TILEMAP6:             db $64,$69,$6D,$69

SUB_GFX6:             JSR GET_DRAW_INFO       ; sets y = OAM offset
                    LDA !157C,x             ; \ $02 = direction
                    STA $02                 ; /
                    LDA $14
                    LSR A
			...
			LDX $03			; \  ���݂̃J�E���^��Ăяo���܂�
			CPX #$03
			BNE NO_YFLIP6		;  ����̃J�E���^�l�̂Ƃ��̂ݔ��]
   	                ORA #$40                ; /    ...flip tile
NO_YFLIP6:		ORA $64                 ; add in tile priority of level
          		STA $0303|!addr,y             ; store tile properties
...
M0X_SPEED:             db $18,$E8 ;��s���x�@�E�A��

SUB_MOTION_00:	;�a���̂��Ƃ��o��@�}���I�Ɏ�����킹�郂�[�V����
	...
	JSR SUB_M0_CHKGROUND
	JSR SUB_M0_CHKGROUND
	;JSL $018022	;X���݂̂̈ړ�
	;JSL $01801A	;�x���݂̂̈ړ��B�n�`�����


JMP END_MOTION

SUB_M0_CHKGROUND:	;���[�V�����O�̒��Œn�`�Ɣ������鏈��
...
SUB_MOTION_03:	;�t�@�C�A�o�����[�V����
	...
	LDA !1588,x ;�I�u�W�F�N�g�Ɛڂ��Ă���̂�
	AND #$08	;�V��ɓ��Ԃ����H
	BEQ NOT_TENJO_MOTION_3
		STZ !AA,x ;�x���x�[��
	NOT_TENJO_MOTION_3:	;���n���ĂȂ�

	LDA !1588,x ;�I�u�W�F�N�g�Ɛڂ��Ă���̂�
	AND #$04	;���n�����H
	BEQ NOT_GROUD_MOTION_3
		;���n������
		STZ !1534,x  ;���[�V�����J�E���^������
		LDA #$04
		STA !C2,x	;���[�V�����ԍ�������ʂ�
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; generate extra sprite �t�@�C�A��΂�
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

GEN_PUTITFIRE:       LDY #$07
EXTRA_LOOP:          LDA $170B|!addr,y
                    BEQ EXTRA_1
                    DEY
                    BPL EXTRA_LOOP
                    RTS
EXTRA_1:             LDA #$0B    ;�X�v���C�g�̎��
                    STA $170B|!addr,y

                    LDA !E4,x   ;x���W���ʃo�C�g
                    STA $171F|!addr,y
                    LDA !14E0,x ;x���W��ʃo�C�g
                    STA $1733|!addr,y

                    LDA !D8,x   ;y���W���ʃo�C�g
                    STA $1715|!addr,y
                    LDA !14D4,x ;y���W��ʃo�C�g
                    STA $1729|!addr,y
		...
		CMP #$00
		BNE LEFT_FIREBALL
			;RIGHT_FIREBALL	;�E�����̂Ƃ��̃t�@�C�A�Ƃ΂�
				LDA #$40   ;x�����������x
                    		STA $1747|!addr,y
			BRA END_X_FIREBALL
		LEFT_FIREBALL:		;�������̂Ƃ��̃t�@�C�A�Ƃ΂�
				LDA #$C0   ;x�����������x
                    		STA $1747|!addr,y
		END_X_FIREBALL:
                    LDA #$FF   ;�ꕔ�X�v���C�g�p�̃^�C�}�[
                    STA $176F|!addr,y
...
SUB_MOTION_04:	;�ď㏸
	...
	LDA !1588,x ;�I�u�W�F�N�g�Ɛڂ��Ă���̂�
	AND #$08	;�V��ɓ��Ԃ����H
	BEQ NOT_TENJO_MOTION_4
		STZ !1534,x  ;���[�V�����J�E���^������
		LDA #$00
		STA !C2,x	;���[�V�����ԍ�������ʂ�
	NOT_TENJO_MOTION_4:	;���n���ĂȂ�
...
SUB_MOTION_06:	;���邮�鉡��]
	...
	JSR SUB_M6_CHKGROUND


JMP END_MOTION

SUB_M6_CHKGROUND:	;���[�V����6�̒��Œn�`�Ɣ������鏈��
	JSL $01802A|!bank             ; update position based on speed values
	LDA !1588,x ;�I�u�W�F�N�g�Ɛڂ��Ă���̂�
	AND #$04	;���n�����H
	BEQ NOT_GROUD_MOTION_6
		STZ !B6,x ;�w���x�[��
		STZ !AA,x ;�x���x�[��
		STZ !1534,x  ;���[�V�����J�E���^������
		LDA #$05
		STA !C2,x	;���[�V�����ԍ�������ʂ�
	NOT_GROUD_MOTION_6:	;���n���ĂȂ�

	LDA !1588,x ;�I�u�W�F�N�g�Ɛڂ��Ă���̂�
	AND #$08	;�V��ɓ��Ԃ����H
	BEQ NOT_TENJO_MOTION_6
		STZ !AA,x ;�x���x�[��
	NOT_TENJO_MOTION_6:	;���n���ĂȂ�

	LDA !1588,x ;�I�u�W�F�N�g�Ɛڂ��Ă���̂�
	AND #$03	;�ǂɂԂ������H
	BEQ NOT_WALL_MOTION_6
		;�������]
		LDA !157C,x             ; | flip the direction status
                EOR #$01                ; |
                STA !157C,x             ; /
...
GEN_NOKOERI:         JSL $02A9DE|!bank             ; \ get an index to an unused sprite slot, RETURN if all slots full
                    ...
                    LDA #$3F             ;�����ɐ����������J�X�^���X�v���C�g�X�v���C�g�ԍ�������
                    PHX
                    TYX
                    STA !7FAB9E,x
                    PLX
