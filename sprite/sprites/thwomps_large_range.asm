...
;;
;; (PSI Ninja edits: enabled ascension glitch fix and greatly increased the awareness/attack range)
;;
...
!FixAscensionGlitchPLS = 1	; (PSI Ninja edit: changed from 0 to 1)
...
AWARE_RANGE:
;	dw $0040	; up
	dw $0100	; up	(PSI Ninja edit: greatly increase range)
	dw $0040	; down
	dw $0080	; right
	dw $0080	; left
